...
func (r *{{.Name}}Repository) FindByID(id int64) (*models.{{.Name}}, error) {
	var m models.{{.Name}}
	err := r.db.QueryRow(
...
func (r *{{.Name}}Repository) Create(m *models.{{.Name}}) (*models.{{.Name}}, error) {
	now := time.Now()
	err := r.db.QueryRow(
...
func (r *{{.Name}}Repository) Update(m *models.{{.Name}}) (*models.{{.Name}}, error) {
